...
<style>
    ...
    /* Glassmorphism Header (Tankou nan foto a) */
    .glass-header {
    ...
    /* Bouton Nouvel Abonnements Style */
    .btn-new {
    ...
    .btn-new:hover { background: #2dd4bf; color: white; }
...
<div class="p-4 md:p-10">
    ...
    <div class="white-card">
        ...
        <div class="divide-y divide-slate-50">
            ...
            <div class="grid-layout relative hover:bg-teal-100/70 transition-colors duration-700 ease-in-out">
                ...
                <div class="text-right">
                    <a href="supprimer_horaire.php?id=<?= $h['id'] ?>" class="bg-rose-50 text-rose-500 hover:bg-rose-500 hover:text-white px-5 py-2 rounded-xl text-[10px] font-black uppercase transition-all">
                        Retirer
                    </a>
                </div>
            </div>

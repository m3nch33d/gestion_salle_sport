    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <table class="min-w-full">
            <thead class="bg-gray-50 border-b">
                <tr class="text-left text-xs font-bold text-gray-500 uppercase tracking-wider shadow-xl">
...
<a href="encaisser.php" class="block p-6 bg-teal-500  text-white rounded-[20px] shadow-lg shadow-emerald-500/30 transition transform hover:-translate-y-1">

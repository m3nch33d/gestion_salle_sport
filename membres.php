...
<div id="main-content" class="container mx-auto space-y-6 md:space-y-8 p-4 md:p-8 animate__animated animate__fadeInUp">
    ...
    <div class="md:bg-white/80 md:backdrop-blur-md md:rounded-[40px] shadow-2xl overflow-hidden border border-white/20">
    <table class="min-w-full">
        <thead class="hidden md:table-header-group">
            <tr class="bg-slate-50/50 border-b border-slate-200 text-slate-400 text-left text-[10px] uppercase font-black tracking-[0.2em] shadow-xl">
        ...
        <tbody class="divide-y divide-slate-100/50">
            <?php foreach ($membres as $m): ?>
                <tr class="hover:bg-teal-50/50 transition-all duration-300 group">

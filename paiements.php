    ...
    <div class="table-container shadow-2xl border border-white/20">
        <table class="min-w-full">
            <thead class="bg-slate-100/50 border-b border-slate-200">
                <tr class="text-left text-xs font-black text-slate-500 uppercase tracking-widest">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-teal-50/50 transition-colors duration-300">
                    ...
                    <td class="px-6 py-5 text-center">
                        ...
                        ?>
                            <span class="px-3 py-1 text-[10px] font-black rounded-lg uppercase <?= $badgeClass ?>">
                                <?= htmlspecialchars($m) ?>
                            </span>
                        <?php else: ?>
                            <span class="text-red-500 text-[10px] font-bold italic">Erreur</span>
                        <?php endif; ?>
                    </td>
                    <td class="px-6 py-5 text-center">

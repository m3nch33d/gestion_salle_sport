...
if ($nombre_de_mois > 0) {
    ...
    // Formatage pour l'affichage (ex: 2.4M ou 500K)
...
<div id="main-content" class="container mx-auto px-4 py-12 animate__animated animate__fadeInUp">
    
    <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
        <div>
            <span class="text-teal-400 font-bold uppercase tracking-[0.3em] text-xs">Système d'analyse 4.0</span>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div class="lg:col-span-8 dashboard-glass p-1">
            <div class="p-8">
                <div class="flex justify-between items-center mb-10">
                    ...
                    <a href="export_finance.php" target="_blank" class="text-[10px] bg-white/10 hover:bg-teal-500 hover:text-slate-900 px-4 py-2 rounded-lg transition-all border border-white/20 uppercase font-black">
                        Exporter CSV
                    </a>
                </div>
        ...
        <div class="lg:col-span-4 space-y-6">
            <div class="dashboard-glass p-8 border-t-4 border-t-rose-500 shadow-2xl shadow-rose-500/10">
            ...
            <div class="bg-gradient-to-br from-teal-500 to-emerald-600 p-8 rounded-[30px] shadow-2xl shadow-teal-500/20 transform hover:scale-[1.02] transition-transform">
                <p class="text-white/70 text-[10px] font-black uppercase tracking-widest">Projection Annuelle</p>
                <h4 class="text-4xl font-black text-white mt-2 stat-value">
                    Est. <?= $projection_format ?>
                </h4>
                <div class="mt-4 flex items-center gap-2">
                    <span class="text-[10px] bg-white/20 px-2 py-1 rounded-full text-white font-bold uppercase">Basé sur <?= $nombre_de_mois ?> mois</span>
                </div>
            </div>
        </div>
    </div>

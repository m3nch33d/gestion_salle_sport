...
<style>
    ...
    /* Ajustement de la bordure sur mobile */
    .table-wrapper {
        border-radius: 30px;
        overflow: hidden;
        border: 8px solid white; /* Un peu moins épais sur mobile pour gagner de la place */
    }
...
<div id="main-content" class="p-3 md:p-8 animate__animated animate__fadeInUp">
    ...
    <div class="table-wrapper bg-white shadow-2xl">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <?php else: ?>
                        ...
                        <tr class="row-hover transition-all">
                            <td class="p-4 md:p-6">
                                <p class="font-black text-slate-800 text-sm md:text-lg uppercase leading-tight"><?= htmlspecialchars($c['nom'] . ' ' . $c['prenom']) ?></p>
                                <p class="text-[10px] md:text-xs text-slate-400 font-mono mt-1"><?= htmlspecialchars($c['telephone']) ?></p>
                            </td>
                            <td class="p-4 md:p-6">
